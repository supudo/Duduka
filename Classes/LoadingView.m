...
+ (id)loadingViewInView:(UIView *)aSuperview {
	CGRect mainFrame = [aSuperview bounds];
	LoadingView *loadingView = [[[LoadingView alloc] initWithFrame:CGRectMake((mainFrame.origin.x - 5), (mainFrame.origin.y + 60), (mainFrame.size.width + 10), (mainFrame.size.height - 56))] autorelease];
	if (!loadingView)
		return nil;
